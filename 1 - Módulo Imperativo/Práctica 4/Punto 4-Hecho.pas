...
type
    ...
    begin
        writeln ('Ingrese los datos correspondientes para almacenar un préstamo. Recuerde que la lectura finaliza con ISBN -1.');
        writeln;
        ...
        if (p.ISBN <> -1) then begin
            writeln ('Ingrese el número del socio.');
            writeln;
            readln (p.socio);
            writeln;
            ...
            readln (p.mes);
            writeln;
            writeln ('Ingrese la cantidad de días del préstamo.');
            writeln;
            readln (p.tiempo);
            writeln;
            writeln ('Datos del préstamo almacenados.');
            writeln;
        end;
    end;

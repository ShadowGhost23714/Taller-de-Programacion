...
public class Ej04 {
    ...
    public static void main(String[] args) {
        ...
        Corista corista1 = new Corista("Pepe", 333, 14, 3);
        Corista corista2 = new Corista("Juan", 444, 13, 2);
        Corista corista3 = new Corista("Rocio", 666, 15, 1);
        ...
        PorHileras corohil = new PorHileras("CoroHileras", direc2, 4,  2, 3);
        Corista corista4 = new Corista("Gonzalo", 542, 12, 3);
        Corista corista5 = new Corista("Veronica", 324,13, 3);
        Corista corista6 = new Corista("Laura", 675, 14, 3);
        Corista corista7 = new Corista("Eduardo", 338, 15, 1);
        Corista corista8 = new Corista("Victoria", 427, 12, 1);
        Corista corista9 = new Corista("Cecilia", 926, 11, 1);
